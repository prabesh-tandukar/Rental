...
class Property extends Model
{
    ...
    protected $fillable = [
        'property_title', 'address', 'city', 'property_category', 'road_size', 'road_type', 'distance', 'distance_unit', 'built_year', 'bedroom', 'kitchen', 'bathroom', 'livingroom', 'parking', 'amenities', 'description', 'price', 'price_unit', 'negotiable', 'owner_name', 'owner_email', 'owner_phone', 'location', 'cover_image', 'latitude', 'longitude', 'user_id'
    ];
