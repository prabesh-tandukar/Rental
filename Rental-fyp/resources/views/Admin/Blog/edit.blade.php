                      ...
                      <ul class="nav nav-pills flex-column">
                        <li class="nav-item active">
                          <a href="{{ route('admin.blog.index') }}" class="nav-link ">
                            <i class="fas fa-align-justify"></i> List Blogs
                          </a>
                        </li>
                        <li class="nav-item">
                          <a href="{{ route('admin.blog.create') }}" class="nav-link">
                            <i class="nav-icon fa fa-plus"></i> Create Blog
                          </a>
                        </li>
                      </ul>
                    </div>
                ...
                <div class="col-md-8">
                  <!-- general form elements -->
                    <div class="box invoice p-3 mb-3">
                        ...
                        <div class="box ">
                                <div class="box-body">
                                    <form method="POST" action="{{ route('admin.blog.edit', $blog->id) }}" enctype="multipart/form-data" >
                                        @csrf
                                        @method('PUT')
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-12 pb-3">
                                                    <div class="form-group">
                                                        ...
                                                        @if(($blog->image!=''))
                                                          <img src="/uploads/blog_images/{{$blog->image}}" width="50"/>
                                                        @endif
                                                        @if ($errors->has('image'))
